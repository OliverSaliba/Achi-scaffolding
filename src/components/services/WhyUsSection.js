    ...
    <section className="w-full bg-white py-[70px]">
      <div className="max-w-[1250px] mx-auto px-[20px]">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-x-[22px] gap-y-[18px] mt-[60px]"
        >
          {[
            ...
            <div
              key={i}
              className="bg-white rounded-[16px] shadow-[0_8px_32px_rgba(0,0,0,0.06)] p-[22px] flex items-center gap-[16px]"
            >
              <ImageWebp
              ...
              />
              <div>
                <div className="font-[Rajdhani] text-[#003A80] text-[38px] font-[700] leading-[1]">
                  {item.value}
                </div>
                <div className="font-saira text-[#4A5C7A] text-[16px] mt-[6px]">
                  {item.label}
                </div>
              </div>
            </div>
